...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net clk_in1_0_1  [get_bd_ports clkin] \
  ...
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs m_axi/Reg] -force
