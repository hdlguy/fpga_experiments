...
proc create_hier_cell_microblaze_1_local_memory { parentCell nameHier } {
  ...
  connect_bd_net -net microblaze_1_Clk  [get_bd_pins clkin] \
...
proc create_root_design { parentCell } {
  ...
  set_property CONFIG.NUM_MI {3} $microblaze_1_axi_periph
  ...
  set_property CONFIG.NUM_PORTS {1} $microblaze_1_xlconcat
  ...
  connect_bd_intf_net -intf_net microblaze_1_axi_dp [get_bd_intf_pins microblaze_1_axi_periph/S00_AXI] [get_bd_intf_pins microblaze_1/M_AXI_DP]
  connect_bd_intf_net -intf_net microblaze_1_axi_periph_M02_AXI [get_bd_intf_pins axi_gpio_1/S_AXI] [get_bd_intf_pins microblaze_1_axi_periph/M02_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_1_intc_axi [get_bd_intf_pins microblaze_1_axi_periph/M00_AXI] [get_bd_intf_pins microblaze_1_axi_intc/s_axi]
  ...
  [get_bd_pins microblaze_1_axi_intc/s_axi_aclk] \
  [get_bd_pins microblaze_1_axi_intc/processor_clk] \
  [get_bd_pins microblaze_1_local_memory/clkin] \
  [get_bd_pins mdm_1/S_AXI_ACLK] \
  [get_bd_pins axi_gpio_1/s_axi_aclk] \
  [get_bd_pins microblaze_1_axi_periph/M02_ACLK]
  connect_bd_net -net microblaze_1_intr  [get_bd_pins microblaze_1_xlconcat/dout] \
  [get_bd_pins microblaze_1_axi_intc/intr]
  ...
  [get_bd_pins microblaze_1_axi_intc/processor_rst]
  ...
  [get_bd_pins microblaze_1_axi_intc/s_axi_aresetn] \
  ...
  assign_bd_address -offset 0x00000000 -range 0x00004000 -target_address_space [get_bd_addr_spaces microblaze_1/Data] [get_bd_addr_segs microblaze_1_local_memory/dlmb_bram_if_cntlr/SLMB/Mem] -force
